...
def initialize(context):
    ...
    api.set_slippage(slippage.FixedSlippage(spread=0.00))
    api.set_commission(commission.PerShare(cost=0.000, min_trade_cost=0.00)) # 0.0003 and 0.00 is about the most we can pay right now for this.
